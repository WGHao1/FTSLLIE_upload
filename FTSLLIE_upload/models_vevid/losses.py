...
class SSIM_14_L2_1_Loss(nn.Module):
    def __init__(self, channels):
        super(SSIM_14_L2_1_Loss, self).__init__()
        self.l2_loss_func = nn.MSELoss()
        self.ssim = SSIM(data_range=1., size_average=True, channel=channels)
        self.alpha = 1.4
...
class SSIM_06_L2_1_Loss(nn.Module):
    def __init__(self, channels):
        super(SSIM_06_L2_1_Loss, self).__init__()
        self.l2_loss_func = nn.MSELoss()
        self.ssim = SSIM(data_range=1., size_average=True, channel=channels)
        self.alpha = 0.6
...
class SSIM_08_L2_1_Loss(nn.Module):
    def __init__(self, channels):
        super(SSIM_08_L2_1_Loss, self).__init__()
        self.l2_loss_func = nn.MSELoss()
        self.ssim = SSIM(data_range=1., size_average=True, channel=channels)
        self.alpha = 0.8
...
class MSSSIM_1_L1_12_Loss(nn.Module):
    def __init__(self, channels):
        super(MSSSIM_1_L1_12_Loss, self).__init__()
        self.l1_loss_func = nn.L1Loss()
        self.ms_ssim = MS_SSIM(data_range=1., size_average=True, channel=channels)
        self.alpha = 1.2
...
class MSSSIM_1_L2_1_Loss(nn.Module):
    def __init__(self, channels):
        super(MSSSIM_1_L2_1_Loss, self).__init__()
        self.l2_loss_func = nn.MSELoss()
        self.ms_ssim = MS_SSIM(data_range=1., size_average=True, channel=channels)
        # self.alpha = 0.84
        self.alpha = 1.
